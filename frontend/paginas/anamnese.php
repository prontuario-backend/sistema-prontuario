...
<body>
    ...
    <div class="main">
        ...
        <div class="conteudo shadow">
            ...
            <div class="conteudo1">
                <div class="queixa conteudo2"><label for="queixa">Queixa principal</label><br>
                    <input type="text">
                </div>

                <div class="historico conteudo2"><label for="historico">Histórico Familiar</label><br>
                    <input type="text">
                </div>


                <div class="exame conteudo2"><label for="exame">Exame Físico</label><br>
                    <input type="text">
                </div>

                <div class="habitos conteudo2"><label for="habitos">Hábitos de Vida</label><br>
                    <input type="text">
                </div>
